  ...
  return (
    <div className="bg-gray-50 flex flex-col flex-shrink-0 h-full relative w-full header-sidebar">
                    ...
                    <div key={space.id} className="space-y-1">
                        <div className="group flex items-center gap-1 pr-1">
                            <button
                                ...
                                className={`flex-1 flex items-center gap-2 px-2 py-1.5 rounded-md text-sm transition-all duration-200
                        ...
                        {!isCollapsed && (
                            <div className="ml-7 space-y-0.5 border-l border-gray-200 pl-2">
                                {spaceLists.map(list => (
                                    <div key={list.id} className="relative group/item w-full flex items-center">
                                        ...
                                        <button 
                                            ...
                                            className={`p-1.5 text-gray-300 hover:text-red-600 hover:bg-red-50 rounded transition-all duration-200 hover:border-red-200 border border-transparent flex-shrink-0 ${activeListId === list.id ? 'opacity-100' : 'opacity-0 group-hover/item:opacity-100'}`}
                                            title="Delete Module"
                                        >
                                            <Trash2 size={12} />
                                        </button>
                                ...
                                <button 
                                    ...
                                    className="w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-xs text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-all duration-200 hover:border-gray-200 border border-transparent"
                                >
      ...
      <div className="p-4 border-t border-gray-200 bg-white space-y-2 shrink-0">
        <button className="flex items-center gap-3 w-full text-sm text-gray-600 hover:text-gray-900 px-2 py-1.5 rounded hover:bg-gray-50 transition-all duration-200 hover:border-gray-200 border border-transparent">
            <Search size={18} />
            Search
        </button>
        <div className="relative">
            <button 
                ...
                className={`flex items-center gap-3 w-full text-sm text-gray-600 hover:text-gray-900 px-2 py-1.5 rounded hover:bg-gray-50 transition-all duration-200 hover:border-gray-200 border border-transparent ${showNotifications ? 'bg-gray-100' : ''}`}
            >
                <div className="relative">
                    <Bell size={18} />
                    {unreadCount > 0 && (
        ...
        <button 
            ...
            className="flex items-center gap-3 w-full text-sm text-gray-600 hover:text-gray-900 px-2 py-1.5 rounded hover:bg-gray-50 transition-all duration-200 hover:border-gray-200 border border-transparent"
        >
            <Settings size={18} />
            Settings
        </button>
